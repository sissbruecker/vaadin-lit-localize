...
export class AvatarGroupDirective extends LocalizeDirective {
  getLocalization() {
    return {
      ...
      activeUsers: {
        one: msg("Currently one active user", {
          id: "vaadin-avatar-group.activeUsers.one",
        }),
        many: msg("Currently {count} active users", {
          id: "vaadin-avatar-group.activeUsers.many",
        }),
      },
      ...
      confirm: {
        delete: {
          ...
          content: msg(
            ...
            { id: "vaadin-crud.confirm.delete.content" }
          ),
          button: {
            confirm: msg("Delete", {
              id: "vaadin-crud.confirm.delete.button.confirm",
            }),
            dismiss: msg("Cancel", {
              id: "vaadin-crud.confirm.delete.button.dismiss",
            }),
          },
        },
        cancel: {
          title: msg("Discard changes", {
            id: "vaadin-crud.confirm.cancel.title",
          }),
          content: msg("There are unsaved changes to this item.", {
            id: "vaadin-crud.confirm.cancel.content",
          }),
          button: {
            confirm: msg("Discard", {
              id: "vaadin-crud.confirm.cancel.button.confirm",
            }),
            dismiss: msg("Cancel", {
              id: "vaadin-crud.confirm.cancel.button.dismiss",
            }),
          },
        },
      },
    ...
    return {
      form: {
        ...
        forgotPassword: msg("Forgot password", {
          id: "vaadin-login.form.forgotPassword",
        }),
      },
      errorMessage: {
        title: msg("Incorrect username or password", {
          id: "vaadin-login.errorMessage.title",
        }),
        message: msg(
          "Check that you have entered the correct username and password and try again.",
          { id: "vaadin-login.errorMessage.message" }
        ),
      },
    };
  }
...
export class MultiSelectComboBoxDirective extends LocalizeDirective {
  getLocalization() {
    return {
      cleared: msg("Selection cleared", {
        id: "vaadin-multi-select-combo-box.cleared",
      }),
      focused: msg("focused. Press Backspace to remove", {
        id: "vaadin-multi-select-combo-box.focused",
      }),
      selected: msg("added to selection", {
        id: "vaadin-multi-select-combo-box.selected",
      }),
      deselected: msg("removed from selection", {
        id: "vaadin-multi-select-combo-box.deselected",
      }),
      total: msg("{count} items selected", {
        id: "vaadin-multi-select-combo-box.total",
      }),
    };
  }
}

export const localizeMultiSelectComboBox = directive(
  MultiSelectComboBoxDirective
);
...
export class UploadDirective extends LocalizeDirective {
  getLocalization() {
    return {
      ...
      error: {
        tooManyFiles: msg("Too Many Files.", {
          id: "vaadin-upload.error.tooManyFiles",
        }),
        fileIsTooBig: msg("File is Too Big.", {
          id: "vaadin-upload.error.fileIsTooBig",
        }),
        incorrectFileType: msg("Incorrect File Type.", {
          id: "vaadin-upload.error.incorrectFileType",
        }),
      },
      uploading: {
        status: {
          connecting: msg("Connecting...", {
            id: "vaadin-upload.uploading.status.connecting",
          }),
          stalled: msg("Stalled", {
            id: "vaadin-upload.uploading.status.stalled",
          }),
          processing: msg("Processing File...", {
            id: "vaadin-upload.uploading.status.processing",
          }),
          held: msg("Queued", { id: "vaadin-upload.uploading.status.held" }),
        },
        remainingTime: {
          prefix: msg("remaining time: ", {
            id: "vaadin-upload.uploading.remainingTime.prefix",
          }),
          unknown: msg("unknown remaining time", {
            id: "vaadin-upload.uploading.remainingTime.unknown",
          }),
        },
        error: {
          serverUnavailable: msg("Upload failed, please try again later", {
            id: "vaadin-upload.uploading.error.serverUnavailable",
          }),
          unexpectedServerError: msg("Upload failed due to server error", {
            id: "vaadin-upload.uploading.error.unexpectedServerError",
          }),
          forbidden: msg("Upload forbidden", {
            id: "vaadin-upload.uploading.error.forbidden",
          }),
        },
      },
      file: {
