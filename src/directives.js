...
export function getAppLayoutTranslation() {
  return {
...
export class AppLayoutDirective extends LocalizeDirective {
  getTranslation() {
    return getAppLayoutTranslation();
  }
}

export const localizeAppLayout = directive(AppLayoutDirective);

export function getAvatarTranslation() {
  return {
...
export class AvatarDirective extends LocalizeDirective {
  getTranslation() {
    return getAvatarTranslation();
  }
}

export const localizeAvatar = directive(AvatarDirective);

export function getAvatarGroupTranslation() {
  return {
...
export class AvatarGroupDirective extends LocalizeDirective {
  getTranslation() {
    return getAvatarGroupTranslation();
  }
}

export const localizeAvatarGroup = directive(AvatarGroupDirective);

export function getCrudTranslation() {
  return {
...
export class CrudDirective extends LocalizeDirective {
  getTranslation() {
    return getCrudTranslation();
  }
}

export const localizeCrud = directive(CrudDirective);

export function getDatePickerTranslation() {
  return {
    monthNames: [
...
export class DatePickerDirective extends LocalizeDirective {
  getTranslation() {
    return getDatePickerTranslation();
  }
}

export const localizeDatePicker = directive(DatePickerDirective);

export function getDateTimePickerTranslation() {
  return {
    monthNames: [
      msg('January', { id: 'vaadin-date-picker.monthNames.0' }),
      msg('February', { id: 'vaadin-date-picker.monthNames.1' }),
...
export class DateTimePickerDirective extends LocalizeDirective {
  getTranslation() {
    return getDateTimePickerTranslation();
  }
}

export const localizeDateTimePicker = directive(DateTimePickerDirective);

export function getLoginTranslation() {
  return {
    form: {
...
export class LoginDirective extends LocalizeDirective {
  getTranslation() {
    return getLoginTranslation();
  }
}

export const localizeLogin = directive(LoginDirective);

export function getMenuBarTranslation() {
  return {
...
export class MenuBarDirective extends LocalizeDirective {
  getTranslation() {
    return getMenuBarTranslation();
  }
}

export const localizeMenuBar = directive(MenuBarDirective);

export function getMessageInputTranslation() {
  return {
...
export class MessageInputDirective extends LocalizeDirective {
  getTranslation() {
    return getMessageInputTranslation();
  }
}

export const localizeMessageInput = directive(MessageInputDirective);

export function getMultiSelectComboBoxTranslation() {
  return {
...
export class MultiSelectComboBoxDirective extends LocalizeDirective {
  getTranslation() {
    return getMultiSelectComboBoxTranslation();
  }
}

export const localizeMultiSelectComboBox = directive(MultiSelectComboBoxDirective);

export function getPasswordFieldTranslation() {
  return {
...
export class PasswordFieldDirective extends LocalizeDirective {
  getTranslation() {
    return getPasswordFieldTranslation();
  }
}

export const localizePasswordField = directive(PasswordFieldDirective);

export function getRichTextEditorTranslation() {
  return {
...
export class RichTextEditorDirective extends LocalizeDirective {
  getTranslation() {
    return getRichTextEditorTranslation();
  }
}

export const localizeRichTextEditor = directive(RichTextEditorDirective);

export function getUploadTranslation() {
  return {
    dropFiles: {
